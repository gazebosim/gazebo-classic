...
////////////////////////////////////////////////////////////////////////////////
/// Get the pose
math::Pose3d BulletMotionState::GetWorldPose() const
{
...
////////////////////////////////////////////////////////////////////////////////
/// Set the pose
void BulletMotionState::SetWorldPose(const math::Pose3d &pose)
{
  this->worldPose = pose;
}
...
void BulletMotionState::SetCoMOffset( const math::Pose3d &com )
{
  this->comOffset = com;
}
...
{
  math::Pose3d result = this->worldPose;
