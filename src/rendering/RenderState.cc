...
{
  this->connections.push_back( event::Events::ConnectShowLightsSignal(
      boost::bind(&RenderState::ShowLightsCB,this) ) );

  this->connections.push_back( event::Events::ConnectShowJointsSignal(
      boost::bind(&RenderState::ShowJointsCB,this) ) );

  this->connections.push_back( event::Events::ConnectShowCamerasSignal(
      boost::bind(&RenderState::ShowCamerasCB,this) ) );

  this->connections.push_back( event::Events::ConnectShowContactsSignal(
      boost::bind(&RenderState::ShowContactsCB,this) ) );

  this->connections.push_back( event::Events::ConnectShowWireframeSignal(
      boost::bind(&RenderState::ShowWireframeCB,this) ) );

  this->connections.push_back( event::Events::ConnectShowBoundingBoxesSignal(
