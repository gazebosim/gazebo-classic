...
namespace gazebo
{
	namespace math
  {
    ...
    class Vector4
    {
      ...
      /// \return The Ostream
      public: friend std::ostream &operator<<( std::ostream &out, const gazebo::math::Vector4 &pt )
      {
      ...
      /// \return The istream
      public: friend std::istream &operator>>( std::istream &in, gazebo::math::Vector4 &pt )
      {
        // Skip white spaces
