...
namespace gazebo
{
	namespace math
  {
    ...
    class Vector2d
    {
      ...
      /// \return The Ostream
      public: friend std::ostream &operator<<( std::ostream &out, const gazebo::math::Vector2d &pt )
      {
        out << pt.x << " " << pt.y;
        return out;
      }
      ...
      /// \return The istream
      public: friend std::istream &operator>>( std::istream &in, gazebo::math::Vector2d &pt )
      {
        // Skip white spaces
