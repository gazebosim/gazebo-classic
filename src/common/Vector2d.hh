...
namespace gazebo
{
	namespace common
  {
    ...
    class Vector2d
    {
      ...
      /// \brief Constructor
      public: Vector2d( const double &x, const double &y );
    
      /// \brief Constructor
      public: Vector2d( const Vector2d &pt );
    
      /// \brief Destructor
      public: virtual ~Vector2d();
    
      /// \brief Calc distance to the given point
      public: double Distance( const Vector2d &pt ) const;
      ...
      public: Vector2d GetCrossProd(const Vector2d &pt) const;
      ...
      /// \return The Ostream
      public: friend std::ostream &operator<<( std::ostream &out, const gazebo::common::Vector2d &pt )
      {
        out << pt.x << " " << pt.y;
        return out;
      }
      ...
      /// \return The istream
      public: friend std::istream &operator>>( std::istream &in, gazebo::common::Vector2d &pt )
      {
        // Skip white spaces
