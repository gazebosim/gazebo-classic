...
void StereoCameraSensor::InitChild()
{
  ...
  this->depthBufferSize = this->imageSizeP->GetValue().x *
...
Ogre::TexturePtr StereoCameraSensor::CreateRTT(const std::string &name,
                                               bool depth)
{
  Ogre::PixelFormat pf;
