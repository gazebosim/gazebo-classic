...
if (PKG_CONFIG_FOUND)
  ...
  if (SOFTCore_FOUND)
    message (STATUS "Looking for SOFTCore - found")
  else()
    BUILD_WARNING ("SOFT not found, for dart (with soft body simulation) physics engine option, please install libsoft-core0.")
  endif()
  if (DARTCore_FOUND AND SOFTCore_FOUND)
    set (HAVE_DART TRUE)
  else()
    set (HAVE_DART FALSE)
  endif()
