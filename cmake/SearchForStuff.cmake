...
if (PKG_CONFIG_FOUND)
  ...
  if (NOT SDF_FOUND)
    BUILD_WARNING ("Missing: sdf. Required for reading and writing SDF files.")
    set (HAVE_SDF OFF CACHE BOOL "Have External SDF" FORCE)
  else()
    set (HAVE_SDF ON CACHE BOOL "Have External SDF" FORCE)
  endif()
