...
if (NOT SDFormat_FOUND)
  ...
  set (SDFormat_PKGCONFIG_CFLAGS ${SDFormat_INCLUDE_DIRS})
  if (NOT "${SDFormat_PKGCONFIG_CFLAGS}" STREQUAL "")
    set (SDFormat_PKGCONFIG_CFLAGS "-I${SDFormat_PKGCONFIG_CFLAGS}")
  endif (NOT "${SDFormat_PKGCONFIG_CFLAGS}" STREQUAL "")
  string (REPLACE ";" " -I" SDFormat_PKGCONFIG_CFLAGS "${SDFormat_PKGCONFIG_CFLAGS}")

  set (SDFormat_PKGCONFIG_LDFLAGS ${SDFormat_LIBRARY_DIRS})
  if (NOT "${SDFormat_PKGCONFIG_LDFLAGS}" STREQUAL "")
    set (SDFormat_PKGCONFIG_LDFLAGS "-L${SDFormat_PKGCONFIG_LDFLAGS}")
  endif(NOT "${SDFormat_PKGCONFIG_LDFLAGS}" STREQUAL "")
  string (REPLACE ";" " -L" SDFormat_PKGCONFIG_LDFLAGS "${SDFormat_PKGCONFIG_LDFLAGS}")
  set (SDFormat_PKGCONFIG_LDFLAGS "${SDFormat_PKGCONFIG_LDFLAGS} ${SDFormat_LIBRARIES}")
