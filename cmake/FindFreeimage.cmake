...
if (NOT freeimage_FOUND)
  ...
  if (WIN32)
    if ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
      find_library(freeimage_LIBRARIES FreeImageLibd)
    else()
      find_library(freeimage_LIBRARIES FreeImageLib)
    endif()
  else(WIN32)
  ...
  if (NOT freeimage_LIBRARIES)
    ...
    message (STATUS "  Looking for libfreeimage - found : ${freeimage_LIBRARIES}")
