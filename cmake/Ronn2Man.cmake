...
ELSE (NOT RONN OR NOT GZIP)
  ...
  MACRO(manpage RONNFILE SECTION)
    SET(RONNFILE_FULL_PATH ${CMAKE_CURRENT_BINARY_DIR}/${RONNFILE})

    add_custom_command(TARGET ${RONNFILE} POST_BUILD
      COMMAND ${CMAKE_SOURCE_DIR}/tools/make_ronn.py ${RONNFILE} ${CMAKE_CURRENT_BINARY_DIR}/${RONNFILE}.${SECTION}.ronn)

    ADD_CUSTOM_COMMAND(
      OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${RONNFILE}.${SECTION}
      DEPENDS ${RONNFILE} ${CMAKE_CURRENT_BINARY_DIR}/${RONNFILE}.${SECTION}.ronn
      COMMAND ${RONN}
