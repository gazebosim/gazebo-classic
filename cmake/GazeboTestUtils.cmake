...
macro (gz_build_tests)
  ...
  #
  #      if (HAVE_BULLET)
  #        target_link_libraries(${BINARY_NAME} gazebo_physics_bullet)
  #      endif()
  #      
  #      if (HAVE_DART)
  #        target_link_libraries(${BINARY_NAME} gazebo_physics_dart)
  #      endif()
  #      
  #      if (HAVE_SIMBODY)
  #        target_link_libraries(${BINARY_NAME} gazebo_physics_simbody)
  #      endif()
  #
