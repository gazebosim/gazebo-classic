 ...
 */
dReal dNormalizeAnglePositive(dReal angle)
{
 ...
 *
 */    
dReal dNormalizeAngle(dReal angle)
{
...
dReal dShortestAngularDistance(dReal from, dReal to)
{
...
dReal dShortestAngularDistanceUpdate(dReal from, dReal to, dReal tol)
{
