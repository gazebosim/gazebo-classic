...
{
  common::Material mat(ignition::math::Color(1.0f, 0.5f, 0.2f, 1.0f));
  EXPECT_TRUE(mat.Ambient() == ignition::math::Color(1.0f, 0.5f, 0.2f, 1.0f));
  EXPECT_TRUE(mat.Diffuse() == ignition::math::Color(1.0f, 0.5f, 0.2f, 1.0f));
  ...
  mat.SetAmbient(ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));
  EXPECT_TRUE(mat.Ambient() == ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));

  mat.SetDiffuse(ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));
  EXPECT_TRUE(mat.Diffuse() == ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));

  mat.SetSpecular(ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));
  EXPECT_TRUE(mat.Specular() == ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));

  mat.SetEmissive(ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));
  EXPECT_TRUE(mat.Emissive() == ignition::math::Color(0.1f, 0.2f, 0.3f, 0.4f));
