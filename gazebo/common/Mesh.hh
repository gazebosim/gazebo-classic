...
namespace gazebo
{
  namespace common
  {
    ...
    class GAZEBO_VISIBLE Mesh
    {
      ...
      public: ignition::math::Vector3d GetMax() const;

      /// \brief Get the minimum X, Y, Z values
      /// \return the lower bounds of the bounding box
      public: ignition::math::Vector3d GetMin() const;
    ...
    class GAZEBO_VISIBLE SubMesh
    {
      ...
      public: ignition::math::Vector3d GetVertex(unsigned int _i) const;
      ...
      public: ignition::math::Vector3d GetNormal(unsigned int _i) const;
      ...
      public: ignition::math::Vector2d GetTexCoord(unsigned int _i) const;
