...
////////////////////////////////////////////////////
void ColladaExporter::Export(Mesh *_mesh)
{
  // Mesh name
  ...
  xmlDoc.LinkEndChild( assetXml );

  xmlDoc.SaveFile( meshName+".dae" );
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadScene(Mesh *_mesh)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadNode(TiXmlElement *_elem, Mesh *_mesh,
...
///////////////////////////////////////////////////
//math::Matrix4 ColladaExporter::LoadNodeTransform(TiXmlElement *_elem)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadController(TiXmlElement *_contrXml,
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadAnimations(TiXmlElement *_xml, Skeleton *_skel)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadAnimationSet(TiXmlElement *_xml, Skeleton *_skel)
//{
...
///////////////////////////////////////////////////
//SkeletonNode* ColladaExporter::LoadSkeletonNodes(TiXmlElement *_xml,
...
///////////////////////////////////////////////////
//void ColladaExporter::SetSkeletonNodeTransform(TiXmlElement *_elem,
//      SkeletonNode *_node)
//{
//  math::Matrix4 transform(math::Matrix4::IDENTITY);
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadGeometry(TiXmlElement *_xml,
...
///////////////////////////////////////////////////
//TiXmlElement *ColladaExporter::GetElementId(const std::string &_name,
...
///////////////////////////////////////////////////
//TiXmlElement *ColladaExporter::GetElementId(TiXmlElement *_parent,
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadVertices(const std::string &_id,
//    const math::Matrix4 &_transform,
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadPositions(const std::string &_id,
//    const math::Matrix4 &_transform,
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadNormals(const std::string &_id,
//    const math::Matrix4 &_transform,
//    std::vector<math::Vector3> &_values)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadTexCoords(const std::string &_id,
...
///////////////////////////////////////////////////
//Material *ColladaExporter::LoadMaterial(const std::string &_name)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadColorOrTexture(TiXmlElement *_elem,
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadPolylist(TiXmlElement *_polylistXml,
//    const math::Matrix4 &_transform,
//    Mesh *_mesh)
//{
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadTriangles(TiXmlElement *_trianglesXml,
//                                  const math::Matrix4 &_transform,
//                                  Mesh *_mesh)
//{
//  SubMesh *subMesh = new SubMesh;
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadLines(TiXmlElement *_xml,
//    const math::Matrix4 &_transform,
//    Mesh *_mesh)
//{
//  SubMesh *subMesh = new SubMesh;
...
///////////////////////////////////////////////////
//float ColladaExporter::LoadFloat(TiXmlElement *_elem)
//{
//  float value = 0;
...
///////////////////////////////////////////////////
//void ColladaExporter::LoadTransparent(TiXmlElement *_elem, Material *_mat)
//{
