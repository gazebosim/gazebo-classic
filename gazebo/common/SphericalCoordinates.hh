...
namespace gazebo
{
  namespace common
  {
    ...
    class GAZEBO_VISIBLE SphericalCoordinates
    {
      ...
      public: ignition::math::Angle GetLatitudeReference() const;

      /// \brief Get reference longitude.
      /// \return Reference longitude.
      public: ignition::math::Angle GetLongitudeReference() const;
      ...
      public: ignition::math::Angle GetHeadingOffset() const;
