...
//////////////////////////////////////////////////
ignition::math::Matrix4d NodeAnimation::GetFrameAt(
    double _time, bool _loop) const
{
  double time = _time;
  if (time > this->length)
  {
...
{
  for (std::map<double, ignition::math::Matrix4d>::iterator iter =
...
//////////////////////////////////////////////////
ignition::math::Matrix4d SkeletonAnimation::GetNodePoseAt(
