...
#ifndef _GPSVISUAL_HH_
#define _GPSVISUAL_HH_
...
namespace gazebo
{
  namespace rendering
  {
    ...
    /// \class GpsVisual GpsVisual.hh rendering/rendering.hh
    /// \brief Visualization for laser data.
    class GAZEBO_VISIBLE GpsVisual : public Visual
    {
      /// \brief Constructor.
      /// \param[in] _name Name of the visual.
      /// \param[in] _vis Pointer to the parent Visual.
      /// \param[in] _topicName Name of the topic that has laser data.
      public: GpsVisual(const std::string &_name, VisualPtr _vis,
                          const std::string &_topicName);

      /// \brief Destructor.
      public: virtual ~GpsVisual();
      ...
      private: void OnNavigationSolution(ConstGpsPtr &_msg);
    };
    /// \}
  }
}
