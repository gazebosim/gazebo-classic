  ...
  namespace VClouds
  {
    ...
    void VClouds::create()
    {
      ...
      mVolCloudsMaterial->getTechnique(0)->getPass(0)->
        getVertexProgramParameters()->setNamedConstant("uRadius",
            mGeometrySettings.Radius);
    ...
    void VClouds::update(const Ogre::Real& timeSinceLastFrame)
    {
      ...
      {
        mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
          getFragmentProgramParameters()->setNamedConstant("uInterpolation",
              mDataManager->_getInterpolation());
        mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
          getFragmentProgramParameters()->setNamedConstant("uSunDirection",
              -mSunDirection);
      }
      else
      {
        ...
        const Ogre::Real& timeSinceLastCameraFrame)
    {
      ...
      if (!isRegistered)
      {
        ...
        SkyXLOG("VClouds warning: unregistered camera registered, manual\
            unregistering is needed before camera destruction");
      }
    ...
    void VClouds::setSunColor(const Ogre::Vector3& SunColor)
    {
      ...
      mVolCloudsMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uSunColor",
            mSunColor);
      mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uSunColor",
            mSunColor);
    ...
    void VClouds::setAmbientColor(const Ogre::Vector3& AmbientColor)
    {
      ...
      mVolCloudsMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uAmbientColor",
            mAmbientColor);
      mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uAmbientColor",
            mAmbientColor);
    ...
    void VClouds::setLightResponse(const Ogre::Vector4& LightResponse)
    {
      ...
      mVolCloudsMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uLightResponse",
            mLightResponse);
      mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uLightResponse",
            mLightResponse);
    ...
    void VClouds::setAmbientFactors(const Ogre::Vector4& AmbientFactors)
    {
      ...
      mVolCloudsMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uAmbientFactors",
            mAmbientFactors);
      mVolCloudsLightningMaterial->getTechnique(0)->getPass(0)->
        getFragmentProgramParameters()->setNamedConstant("uAmbientFactors",
            mAmbientFactors);
