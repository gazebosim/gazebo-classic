    ...
    class DllExport GeometryManager
    {
      public:
        ...
        */
        ...
        /** Create
          @param Height x = Field altitude, y: Field height (both in world
          coordinates)
          @param Radius Radius
        ...
        */
        ...
        /** Update render queue group
          ...
          @remarks Only for internal use. Use
          VClouds::setRenderQueueGroups(...) instead.
          */
      ...
      private:
        ...
        */
        ...
        /** Update geometry
          ...
          @param timeSinceLastFrame Time since last frame
          */
        void _updateGeometry(Ogre::Camera* c,
