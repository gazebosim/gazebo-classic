    ...
    public:
      ...
      */
      ...
      /** Create all resources
        @param radius Volumetric cloud field radius, -1 to use current
        VClouds::mGeometrySettings::Radius
        */
      ...
      /** Notify camera render, to be invoked per-camera and per-frame
        ...
        @remarks The VClouds system needs the CAMERA time since last frame,
        so here we assume that all render targets
        are being updated one time per frame(in other words, all render
        targets are being updated at the same rate)
        */
      ...
      */
      ...
      /** Set height parameters
        ...
        For autocalculated height based on the radius length set (-1,-1) as
        height params
        */
      ...
      /** Get height parameters
        @return Height: x = Cloud field y-coord start, y: Field height (both
        in world coordinates)
        */
      ...
      /** Set autoupdate
        @Autoupdate true if you want to update volumetric clouds wind
        depending of the SkyX time multiplier
        @remarks You can use VClouds->setWindSpeed(..) for different winds
        speeds
        */
      ...
      /** Get autoupdate
        @return true if you want to update volumetric clouds wind depending
        of the SkyX time multiplier
        */
