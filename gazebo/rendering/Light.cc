...
void Light::Load()
{
  ...
  {
    ignthrow("Ogre Error:" << e.getFullDescription() << "\n" << \
...
void Light::Update()
{
  ...
  this->SetDiffuseColor(
      this->sdf->GetElement("diffuse")->Get<ignition::common::Color>());
  this->SetSpecularColor(
      this->sdf->GetElement("specular")->Get<ignition::common::Color>());
  this->SetDirection(
      this->sdf->Get<ignition::math::Vector3>("direction"));
...
void Light::CreateVisual()
{
  ...
  {
    float s =.5;
    this->line->AddPoint(ignition::math::Vector3(-s, -s, 0));
    this->line->AddPoint(ignition::math::Vector3(-s, s, 0));
    ...
    this->line->AddPoint(ignition::math::Vector3(0, 0, 0));
    this->line->AddPoint(ignition::math::Vector3(0, 0, -s));
  }
  if (lightType == "point")
  {
    float s = 0.1;
  ...
  else if (lightType == "spot")
  {
    ...
    unsigned int i = 0;
    this->line->AddPoint(ignition::math::Vector3(0, 0, 0));
    this->line->AddPoint(ignition::math::Vector3(angles[i], angles[i], -range));
    ...
    for (i = 0; i < 2; i++)
    {
      ...
      this->line->AddPoint(
          ignition::math::Vector3(angles[i], angles[i], -range));
...
//////////////////////////////////////////////////
void Light::SetPosition(const ignition::math::Vector3 &_p)
{
  this->visual->SetPosition(_p);
}

//////////////////////////////////////////////////
ignition::math::Vector3 Light::GetPosition() const
{
...
void Light::SetLightType(const std::string &_type)
{
  ...
  {
    ignerr << "Unknown light type[" << _type << "]\n";
  }
...
//////////////////////////////////////////////////
void Light::SetDiffuseColor(const ignition::common::Color &_color)
{
  sdf::ElementPtr elem = this->sdf->GetElement("diffuse");

  if (_color != elem->Get<ignition::common::Color>())
    elem->Set(_color);
...
//////////////////////////////////////////////////
ignition::common::Color Light::GetDiffuseColor() const
{
  return this->sdf->GetElement("diffuse")->Get<ignition::common::Color>();
}

//////////////////////////////////////////////////
ignition::common::Color Light::GetSpecularColor() const
{
  return this->sdf->GetElement("specular")->Get<ignition::common::Color>();
}

//////////////////////////////////////////////////
void Light::SetSpecularColor(const ignition::common::Color &_color)
{
  sdf::ElementPtr elem = this->sdf->GetElement("specular");

  if (elem->Get<ignition::common::Color>() != _color)
    elem->Set(_color);
...
//////////////////////////////////////////////////
void Light::SetDirection(const ignition::math::Vector3 &_dir)
{
  // Set the direction which the light points
  ignition::math::Vector3 vec = _dir;
  vec.Normalize();

  if (vec != this->sdf->Get<ignition::math::Vector3>("direction"))
...
//////////////////////////////////////////////////
ignition::math::Vector3 Light::GetDirection() const
{
  return this->sdf->Get<ignition::math::Vector3>("direction");
}
