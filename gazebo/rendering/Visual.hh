...
namespace gazebo
{
  namespace rendering
  {
      ...
      public std::enable_shared_from_this<Visual>
    {
      ...
      /// \deprecated See ignition::math::Color Ambient() const;
      ...
      /// \deprecated See ignition::math::Color Diffuse() const;
      ...
      /// \deprecated See ignition::math::Color Specular() const;
      ...
      /// \deprecated See ignition::math::Color Emissive() const;
