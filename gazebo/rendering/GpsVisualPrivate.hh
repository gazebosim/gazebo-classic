...
#ifndef _GPSVISUAL_PRIVATE_HH_
#define _GPSVISUAL_PRIVATE_HH_
...
namespace gazebo
{
  namespace rendering
  {
    ...
    class GpsVisualPrivate : public VisualPrivate
    {
      /// \brief Pointer to a node that handles communication.
      public: transport::NodePtr node;

      /// \brief Subscription to the laser data.
      public: transport::SubscriberPtr gpsSub;

      /// \brief Renders the laser data.
      public: std::map<std::string,DynamicLines*> satLinks;
      ...
      public: boost::shared_ptr<msgs::Gps const> gpsMsg;
