...
{
  gazebo::msgs::Any msg = gazebo::msgs::ConvertAny(ignition::math::Vector3d(1, 2, 3));
...
{
  gazebo::msgs::Any msg = gazebo::msgs::ConvertAny(ignition::math::Color(.1, .2, .3, 1.0));
...
{
  gazebo::msgs::Vector3d msg = gazebo::msgs::Convert(ignition::math::Vector3d(1, 2, 3));
...
TEST_F(MsgsTest, ConvertMathQuaterionToMsgs)
{
  gazebo::msgs::Quaternion msg =
    gazebo::msgs::Convert(ignition::math::Quaterniond(M_PI * 0.25, M_PI * 0.5, M_PI));
...
{
  gazebo::msgs::Color msg = gazebo::msgs::Convert(ignition::math::Color(.1, .2, .3, 1.0));
...
//////////////////////////////////////////////////
void CompareMsgsShaderTypeToString(const gazebo::msgs::Material::ShaderType _type)
{
  EXPECT_EQ(_type, gazebo::msgs::ConvertShaderType(gazebo::msgs::ConvertShaderType(_type)));
}

//////////////////////////////////////////////////
TEST_F(MsgsTest, ConvertMsgsShaderTypeToString)
{
  CompareMsgsShaderTypeToString(gazebo::msgs::Material::NORMAL_MAP_OBJECT_SPACE);
  CompareMsgsShaderTypeToString(gazebo::msgs::Material::NORMAL_MAP_TANGENT_SPACE);
...
{
  EXPECT_EQ(_type, gazebo::msgs::ConvertJointType(gazebo::msgs::ConvertJointType(_type)));
}
...
{
  EXPECT_EQ(_type, gazebo::msgs::ConvertGeometryType(gazebo::msgs::ConvertGeometryType(_type)));
}
...
TEST_F(MsgsTest, ConvertMsgsGeometryTypeToString)
{
  ...
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::BOX), "box");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::SPHERE), "sphere");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::CYLINDER), "cylinder");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::PLANE), "plane");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::IMAGE), "image");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::HEIGHTMAP), "heightmap");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::MESH), "mesh");
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType(gazebo::msgs::Geometry::POLYLINE), "polyline");

  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("box"), gazebo::msgs::Geometry::BOX);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("sphere"), gazebo::msgs::Geometry::SPHERE);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("cylinder"), gazebo::msgs::Geometry::CYLINDER);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("plane"), gazebo::msgs::Geometry::PLANE);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("image"), gazebo::msgs::Geometry::IMAGE);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("heightmap"), gazebo::msgs::Geometry::HEIGHTMAP);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("mesh"), gazebo::msgs::Geometry::MESH);
  EXPECT_EQ(gazebo::msgs::ConvertGeometryType("polyline"), gazebo::msgs::Geometry::POLYLINE);
}
...
{
  gazebo::msgs::Quaternion msg;
  gazebo::msgs::Set(&msg, ignition::math::Quaterniond(M_PI * 0.25, M_PI * 0.5, M_PI));
  EXPECT_DOUBLE_EQ(msg.x(), -0.65328148243818818);
  EXPECT_DOUBLE_EQ(msg.y(), 0.27059805007309856);
  EXPECT_DOUBLE_EQ(msg.z(), 0.65328148243818829);
  EXPECT_DOUBLE_EQ(msg.w(), 0.27059805007309851);
...
TEST_F(MsgsTest, SetPose)
{
  ...
  gazebo::msgs::Set(&msg, ignition::math::Pose3d(ignition::math::Vector3d(1, 2, 3),
        ignition::math::Quaterniond(M_PI * 0.25, M_PI * 0.5, M_PI)));
...
void CheckGPSSensorMsg(const gazebo::msgs::GPSSensor &_msg)
{
  ...
  EXPECT_EQ(_msg.velocity().horizontal_noise().type(), gazebo::msgs::SensorNoise::NONE);
...
TEST_F(MsgsTest, LogicalCameraSensorFromSDF)
{
  ...
  sdf::ElementPtr elem = gazebo::msgs::LogicalCameraSensorToSDF(msg.logical_camera());
  gazebo::msgs::LogicalCameraSensor sensorMsg = gazebo::msgs::LogicalCameraSensorFromSDF(elem);
...
TEST_F(MsgsTest, VisualFromSDF_BadFogType)
{
  ...
  EXPECT_THROW(gazebo::msgs::Scene msg = gazebo::msgs::SceneFromSDF(sdf), common::Exception);
}
...
TEST_F(MsgsTest, MeshFromSDF)
{
  ...
  gazebo::msgs::MeshGeom msg = gazebo::msgs::MeshFromSDF(sdf->GetElement("mesh"));
  EXPECT_TRUE(msg.has_filename());
...
TEST_F(MsgsTest, AxisFromSDF)
{
  ...
  EXPECT_EQ(gazebo::msgs::ConvertIgn(msg.xyz()), ignition::math::Vector3d(0, 0, 1));
...
TEST_F(MsgsTest, JointFromSDF)
{
  ...
  EXPECT_EQ(gazebo::msgs::ConvertIgn(axisMsg.xyz()), ignition::math::Vector3d(1, 0, 0));
...
TEST_F(MsgsTest, GeometryToSDF)
{
  ...
  gazebo::msgs::Set(planeGeom->mutable_normal(), ignition::math::Vector3d(0, 0, 1.0));
  gazebo::msgs::Set(planeGeom->mutable_size(), ignition::math::Vector2d(0.5, 0.8));
  ...
  gazebo::msgs::Set(meshGeom->mutable_scale(), ignition::math::Vector3d(2.3, 1.2, 2.9));
...
TEST_F(MsgsTest, MaterialToSDF)
{
  ...
  const gazebo::msgs::Material::ShaderType type = gazebo::msgs::Material::VERTEX;
