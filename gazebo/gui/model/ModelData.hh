...
namespace gazebo
{
  namespace gui
  {
    ...
    class GZ_GUI_VISIBLE LinkData : public QObject
    {
      ...
      public: static double ComputeVolume(const gazebo::msgs::Collision &_collision);
      ...
      public: std::map<rendering::VisualPtr, gazebo::msgs::Visual> deletedVisuals;
      ...
      public: std::map<rendering::VisualPtr, gazebo::msgs::Collision> collisions;

      /// \brief Deleted collisions of the link.
      public: std::map<rendering::VisualPtr, gazebo::msgs::Collision> deletedCollisions;
