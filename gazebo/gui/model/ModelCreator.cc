    ...
    const bool _selected)
{
  ...
  // Not selecting nested links for now
  if (itLink != this->dataPtr->allLinks.end() && (*itLink).second->nested)
  {
    gzwarn << "Selecting nested links is currently disabled." << std::endl;
    return;
  }
