...
void JointMaker_TEST::JointDefaultProperties()
{
  ...
  QVERIFY(gazebo::msgs::ConvertJointType(
        rev2joint->jointMsg->type()) == "revolute2");
  QCOMPARE(gazebo::msgs::ConvertIgn(rev2joint->jointMsg->pose()),
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(rev2Axis1Msg.xyz()),
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(rev2Axis2Msg.xyz()),
  ...
  // verify default values
  QVERIFY(gazebo::msgs::ConvertJointType(
        prisJoint->jointMsg->type()) == "prismatic");
  QCOMPARE(gazebo::msgs::ConvertIgn(prisJoint->jointMsg->pose()),
      ignition::math::Pose3d::Zero);
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(prisAxis1Msg.xyz()),
      ignition::math::Vector3d(1, 0, 0));
  ...
  // verify default values
  QVERIFY(gazebo::msgs::ConvertJointType(
        gearboxJoint->jointMsg->type()) == "gearbox");
  QCOMPARE(gazebo::msgs::ConvertIgn(gearboxJoint->jointMsg->pose()),
      ignition::math::Pose3d::Zero);
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(gearboxAxis1Msg.xyz()),
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(gearboxAxis2Msg.xyz()),
      ignition::math::Vector3d(0, 0, 1));
  ...
  // verify default values
  QVERIFY(gazebo::msgs::ConvertJointType(
        fixedJoint->jointMsg->type()) == "fixed");
  QCOMPARE(gazebo::msgs::ConvertIgn(fixedJoint->jointMsg->pose()),
      ignition::math::Pose3d::Zero);
...
void JointMaker_TEST::UpdateMsg()
{
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(msg1->pose()),
      ignition::math::Pose3d::Zero);
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(msg2->pose()), pose2);
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(msg3->pose()), pose3);
  ...
  QCOMPARE(gazebo::msgs::ConvertIgn(msg4->pose()), pose4);
