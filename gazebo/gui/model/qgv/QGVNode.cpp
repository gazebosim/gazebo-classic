...
#include <QPainter>
#include <iostream>
QGVNode::QGVNode(QGVNodePrivate *node, QGVScene *qgvscene): _scene(qgvscene), _node(node)
{
...
void QGVNode::paint(QPainter * painter, const QStyleOptionGraphicsItem */*_option*/, QWidget */*_widget*/)
{
    painter->save();
