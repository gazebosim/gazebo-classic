  ...
  : dataPtr(new MainWindowPrivate)
{
  ...
  this->dataPtr->modelListWidget = new ModelListWidget(dock);
  dock->setWidget(this->dataPtr->modelListWidget);
  ...
  this->dataPtr->renderWidget = new gui::RenderWidget(this);
  this->setCentralWidget(this->dataPtr->renderWidget);
