...
namespace gazebo
{
  ...
  namespace gui
  {
    class ModelBuilderWidget : public QWidget
    {
      ...
      private: void OnBoxCreate(const ignition::math::Vector3 &pos,
                                const ignition::math::Vector3 &scale);

      private: void OnSphereCreate(const ignition::math::Vector3 &pos,
                                   const ignition::math::Vector3 &scale);

      private: void OnCylinderCreate(const ignition::math::Vector3 &pos,
                                     const ignition::math::Vector3 &scale);
