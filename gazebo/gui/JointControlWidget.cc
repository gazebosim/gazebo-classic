    ...
    dataPtr(new JointForceControlPrivate())
{
  ...
  this->dataPtr->forceSpin->setRange(-ignition::math::MAX_D, ignition::math::MAX_D);
    ...
    dataPtr(new JointPIDPosControlPrivate())
{
  ...
  this->dataPtr->posSpin->setRange(-ignition::math::MAX_D, ignition::math::MAX_D);
  ...
  this->dataPtr->pGainSpin->setRange(-ignition::math::MAX_D, ignition::math::MAX_D);
  ...
  this->dataPtr->iGainSpin->setRange(-ignition::math::MAX_D, ignition::math::MAX_D);
  ...
  this->dataPtr->dGainSpin->setRange(-ignition::math::MAX_D, ignition::math::MAX_D);
