/*
 * Copyright (C) 2011-2014 Open Source Robotics Foundation
 *
...
void DataLogger_TEST::StressTest()
{
  QBENCHMARK
  {
    ...
    // There should be (count * 0.5) log directories in $tmpDir/gazebo_test
    // due to the record button being toggled.
    unsigned int dirCount = 0;
    for (boost::filesystem::directory_iterator iter(tmpDir / "gazebo_test");
