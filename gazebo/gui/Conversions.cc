...
//////////////////////////////////////////////////
QPoint Conversions::Convert(const ignition::math::Vector2i &_pt)
{
  return QPoint(_pt.X(), _pt.Y());
}

//////////////////////////////////////////////////
ignition::math::Vector2i Conversions::Convert(const QPoint &_pt)
{
  return ignition::math::Vector2i(_pt.x(), _pt.y());
}
