...
#ifndef _ORIENTATION_SENSOR_HH_
#define _ORIENTATION_SENSOR_HH_
...
namespace gazebo
{
  namespace sensors
  {
    ...
    /// \brief OrientationSensor to provide position measurement.
    class GAZEBO_VISIBLE OrientationSensor: public Sensor
    {
      ...
      /// \brief Accessor for current orientation as Euler angles
      /// \return Current orientation as Euler angles
      public: math::Vector3 OrientationSensor::GetEuler()  const;

      /// \brief Accessor for current orientation as quaternion
      /// \return Current orientation as quaternion
      public: math::Quaternion OrientationSensor::GetQuaternion()  const;
      ...
      private: msgs::Orientaion lastOrientMsg;
    };
    /// \}
  }
}
