...
//////////////////////////////////////////////////
TEST_F(Sensor_TEST, SensorPluginInfo)
{
  ...
  {
    pluginUri.Parse(
        "data://world/default/model/camera_model/link/my_link/sensor/camera/plugin/depth_camera_plugin");
...
//////////////////////////////////////////////////
TEST_F(SensorTest, PluginInfoFailures)
{
  this->Load("worlds/depth_camera.world", true);
  ...
  {
    pluginUri.Parse("data://world/default/model/camera_model/link/my_link/sensor/camera/plugin/");
  ...
  gzmsg << "Wrong sensor" << std::endl;
  {
    pluginUri.Parse("data://world/default/model/camera_model/link/my_link/sensor/wrong/plugin/depth_camera_plugin");
    model->PluginInfo(pluginUri, plugins, success);
  ...
  {
    pluginUri.Parse("data://world/default/model/camera_model/link/my_link/sensor/camera/");
    model->PluginInfo(pluginUri, plugins, success);
