...
#ifndef _GAZEBO_ORNSTEIN_NOISE_MODEL_HH_
#define _GAZEBO_ORNSTEIN_NOISE_MODEL_HH_
...
namespace gazebo
{
  namespace sensors
  {
    ...
    class GAZEBO_VISIBLE OrnsteinNoiseModel : public Noise
    {
        /// \brief Constructor.
        public: OrnsteinNoiseModel();

        /// \brief Destructor.
        public: virtual ~OrnsteinNoiseModel();
        ...
        /// \brief Accessor for reversion rate.
        /// \return Reversion rate of Ornstein-Uhlenbeck noise
