...
class Noise_TEST : public gazebo::testing::AutoLogFixture { };
...
TEST_F(Noise_TEST, ApplyGaussian)
{
...
TEST_F(Noise_TEST, ApplyGaussianQuantized)
{
...
TEST_F(Noise_TEST, OnApplyNoise)
{
