...
///////////////////////////////////////////////////////////////////////////////
// Check that a model at (0,0,0,0,0,0) has mag field equal to global
  ...
  const std::string &_physicsEngine)
{
  ...
  math::Pose modelPose(0, 0, 0, 0, 0, 1.57079632679);
  ...
  math::Vector3 M = world->GetPhysicsEngine()->GetMagneticField();
