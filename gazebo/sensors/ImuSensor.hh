...
namespace gazebo
{
  namespace sensors
  {
    ...
    class ImuSensor: public Sensor
    {
      ...
      public: ignition::math::Vector3 GetAngularVelocity() const;

      /// \brief Returns the imu linear acceleration
      /// \return Linear acceleration.
      public: ignition::math::Vector3 GetLinearAcceleration() const;
      ...
      public: ignition::math::Quaternion GetOrientation() const;
      ...
      private: ignition::math::Pose referencePose;

      /// \brief Save previous imu linear velocity for computing acceleration.
      private: ignition::math::Vector3 lastLinearVel;

      /// \brief Imu linear acceleration
      private: ignition::math::Vector3 linearAcc;

      /// \brief store gravity vector to be added to the imu output.
      private: ignition::math::Vector3 gravity;
