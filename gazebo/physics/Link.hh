...
namespace gazebo
{
  ...
  namespace physics
  {
    ...
    class GAZEBO_VISIBLE Link : public Entity
    {
      ...
      ///         frame.
      public: ignition::math::Pose3d GetWorldCoGPose() const;
      ...
      public: virtual ignition::math::Vector3d GetWorldLinearVel() const
              {return this->GetWorldLinearVel(ignition::math::Vector3d::Zero);}
      ...
      ///         frame.
      public: virtual ignition::math::Vector3d GetWorldCoGLinearVel() const = 0;

      /// \brief Get the linear velocity of the body.
      /// \return Linear velocity of the body.
      public: ignition::math::Vector3d GetRelativeLinearVel() const;

      /// \brief Get the angular velocity of the body.
      /// \return Angular velocity of the body.
      public: ignition::math::Vector3d GetRelativeAngularVel() const;

      /// \brief Get the linear acceleration of the body.
      /// \return Linear acceleration of the body.
      public: ignition::math::Vector3d GetRelativeLinearAccel() const;
      ...
      public: ignition::math::Pose3d GetWorldInertialPose() const;
      ...
      public: ignition::math::Matrix3d GetWorldInertiaMatrix() const;
