 ...
 *
*/
#ifndef _GAZEBO_PHYSICS_BULLET_BULLETUNIVERSALJOINT_HH_
#define _GAZEBO_PHYSICS_BULLET_BULLETUNIVERSALJOINT_HH_
  ...
  namespace physics
  {
      ...
      : public UniversalJoint<BulletJoint>
    {
      ...
      public: virtual void SetVelocity(
                  const unsigned int _index, const double _angle);
