 ...
 *
*/
#ifndef _GAZEBO_PHYSICS_PLANESHAPE_HH_
#define _GAZEBO_PHYSICS_PLANESHAPE_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE PlaneShape : public Shape
    {
      ...
      /// \deprecated See function that accepts ignition::math parameters.
      public: void SetNormal(const math::Vector3 &_norm) GAZEBO_DEPRECATED(7.0);
      ...
      public: math::Vector3 GetNormal() const GAZEBO_DEPRECATED(7.0);
      ...
      /// \deprecated See function that accepts ignition::math parameters.
      public: void SetSize(const math::Vector2d &_size) GAZEBO_DEPRECATED(7.0);
      ...
      /// \deprecated See function that returns an ignition::math object.
      public: math::Vector2d GetSize() const GAZEBO_DEPRECATED(7.0);
