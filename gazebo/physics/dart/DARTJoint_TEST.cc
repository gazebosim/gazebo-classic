...
class DARTJoint_TEST : public ServerFixture
{
};
...
//////////////////////////////////////////////////////////////////////////
//TEST_F(DARTJoint_TEST, GetForceTorqueWithAppliedForce)
//{
//  // Load our force torque test world
//  Load("worlds/force_torque_test2.world", true, "dart");
...
//  EXPECT_EQ(physics->GetType(), "dart");
...
//// with cfm damping
//////////////////////////////////////////////////////////////////////////
//TEST_F(DARTJoint_TEST, CFMDamping)
//{
//  // Load our force torque test world
...
// torques again
////////////////////////////////////////////////////////////////////////
TEST_F(DARTJoint_TEST, GetForceTorque)
{
  // Load our force torque test world
  Load("worlds/force_torque_test.world", true, "dart");
