...
#include "gazebo/physics/dart/DARTTrimeshShape.hh"
...
//////////////////////////////////////////////////
DARTTrimeshShape::DARTTrimeshShape(CollisionPtr _parent) : TrimeshShape(_parent)
{
//   this->odeData = NULL;
//   this->vertices = NULL;
//   this->indices = NULL;
...
//////////////////////////////////////////////////
DARTTrimeshShape::~DARTTrimeshShape()
{
...
//////////////////////////////////////////////////
void DARTTrimeshShape::Update()
{
//   DARTCollisionPtr ocollision =
...
//////////////////////////////////////////////////
void DARTTrimeshShape::Load(sdf::ElementPtr /*_sdf*/)
{
//   TrimeshShape::Load(_sdf);
}

//////////////////////////////////////////////////
void DARTTrimeshShape::Init()
{
//   TrimeshShape::Init();
//   if (!this->mesh)
//     return;
// 
//   DARTCollisionPtr pcollision =
