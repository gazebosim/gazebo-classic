...
//   DARTLinkPtr pLink =
//     boost::shared_static_cast<DARTLink>(this->collisionParent->GetLink());
//   pLink->SetSpaceId(this->raySpaceId);
//   boost::shared_static_cast<DARTCollision>(_parent)->SetSpaceId(
//       this->raySpaceId);
}
...
{
//   DARTPhysicsPtr ode = boost::shared_dynamic_cast<DARTPhysics>(
//       this->GetWorld()->GetPhysicsEngine());
// 
//   if (ode == NULL)
//     gzthrow("Invalid physics engine. Must use DART.");
// 
...
// //////////////////////////////////////////////////
// void DARTMultiRayShape::UpdateCallback(void *_data, dGeomID _o1, dGeomID _o2)
// {
//   dContactGeom contact;
//   DARTCollision *collision1, *collision2 = NULL;
//   DARTCollision *rayCollision = NULL;
//   DARTCollision *hitCollision = NULL;
//   DARTMultiRayShape *self = NULL;
// 
//   self = static_cast<DARTMultiRayShape*>(_data);
// 
//   // Check space
...
//     {
//       collision1 = static_cast<DARTCollision*>(
//           dGeomGetData(dGeomTransformGetGeom(_o1)));
//     }
//     else
//       collision1 = static_cast<DARTCollision*>(dGeomGetData(_o1));
// 
//     if (dGeomGetClass(_o2) == dGeomTransformClass)
//     {
//       collision2 =
//         static_cast<DARTCollision*>(dGeomGetData(dGeomTransformGetGeom(_o2)));
//     }
//     else
//     {
//       collision2 = static_cast<DARTCollision*>(dGeomGetData(_o2));
//     }
// 
...
//     // that the DART dRayClass is used *soley* by the RayCollision.
//     if (dGeomGetClass(_o1) == dRayClass)
//     {
//       rayCollision = static_cast<DARTCollision*>(collision1);
//       hitCollision = static_cast<DARTCollision*>(collision2);
...
//       rayCollision = static_cast<DARTCollision*>(collision2);
//       hitCollision = static_cast<DARTCollision*>(collision1);
...
//         {
//           // gzerr << "DARTMultiRayShape UpdateCallback dSpaceCollide2 "
//           //      << " depth[" << contact.depth << "]"
