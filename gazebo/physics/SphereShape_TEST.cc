...
TEST_F(SphereShapeTest, Scale)
{
  ...
  sphere->SetScale(ignition::math::Vector3(1.5, 1.5, 1.5));
  radius = sphere->GetRadius();
  EXPECT_DOUBLE_EQ(radius, 0.75);

  sphere->SetScale(ignition::math::Vector3(2.0, 2.0, 2.0));
  radius = sphere->GetRadius();
  EXPECT_DOUBLE_EQ(radius, 1.0);

  // reset scale
  sphere->SetScale(ignition::math::Vector3(1.0, 1.0, 1.0));
  radius = sphere->GetRadius();
  EXPECT_DOUBLE_EQ(radius, 0.5);
  ...
  sphere->SetScale(ignition::math::Vector3(100.0, 100.0, 100.0));
  radius = sphere->GetRadius();
  EXPECT_DOUBLE_EQ(radius, 250.0);

  sphere->SetScale(ignition::math::Vector3(0.1, 0.1, 0.1));
  radius = sphere->GetRadius();
  ...
  sphere->SetScale(ignition::math::Vector3(0.5, 1.0, 2.5));
  radius = sphere->GetRadius();
  ...
  sphere->SetScale(ignition::math::Vector3(-1.0, -2.0, -3.0));
  radius = sphere->GetRadius();
  EXPECT_DOUBLE_EQ(radius, 1.25);
}
