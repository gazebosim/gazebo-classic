  ...
  {
    {
      ...
      if (!bounceElem)
        gzerr << "Surface bounce sdf member is nullptr" << std::endl;
      else
      {
...

    {
      ...
      if (!frictionElem)
        gzerr << "Surface friction sdf member is nullptr" << std::endl;
      else
      {
        ...
        if (!frictionOdeElem)
          gzerr << "Surface friction ode sdf member is nullptr" << std::endl;
        else
        {
...

    {
      ...
      else
      {
        ...
        if (!contactOdeElem)
          gzerr << "Surface contact ode sdf member is nullptr" << std::endl;
        {
