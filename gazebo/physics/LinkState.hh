...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE LinkState : public State
    {
      ...
      /// \brief Velocity of the link (linear and angular) in the world frame.
      private: ignition::math::Pose3d velocity;

      /// \brief Acceleration of the link (linear and angular) in the world frame.
      private: ignition::math::Pose3d acceleration;

      /// \brief Force on the link(linear and angular) in the world frame.
