...
////////////////////////////////////////////////////////////////////////
TEST_F(PluginJoint_TEST, ImplicitDamping)
{
  ...
  EXPECT_TRUE(boost::dynamic_pointer_cast<physics::PluginJoint>(joint_0)->
      UsesImplicitSpringDamper());
  EXPECT_TRUE(boost::dynamic_pointer_cast<physics::PluginJoint>(joint_1)->
      UsesImplicitSpringDamper());
