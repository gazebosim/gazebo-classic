 ...
 *
*/
#ifndef _PluginJOINT_HH_
#define _PluginJOINT_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GAZEBO_VISIBLE PluginJoint : public Joint
    {
      ...
      public: PluginJoint(BasePtr _parent);

      /// \brief Destructor.
      public: virtual ~PluginJoint();
      ...
      /// \brief Get an Plugin joint parameter.
      ///
      ...
      /// \brief Set an Plugin joint paramter.
      ///
      ...
      /// This is used by Plugin to store external force applied by the user.
