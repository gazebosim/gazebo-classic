 ...
 *
*/
/* Desc: A Plugin hinge joint
 * Author: Nate Koenig
 * Date: 21 May 2003
 */

#ifndef _PluginHINGEJOINT_HH_
#define _PluginHINGEJOINT_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GAZEBO_VISIBLE PluginHingeJoint : public HingeJoint<PluginJoint>
    {
      ...
      public: PluginHingeJoint(BasePtr _parent);

      /// \brief Destructor.
      public: virtual ~PluginHingeJoint();
