...
#ifndef _PluginSURFACEPARAMS_HH_
#define _PluginSURFACEPARAMS_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GAZEBO_VISIBLE PluginSurfaceParams : public SurfaceParams
    {
      ...
      /// \brief Destructor.
      public: virtual ~PluginSurfaceParams();
      ...
      /// \sa    See for example
      ///        http://www.plugin.org/plugin-latest-userguide.html#sec_3_8_2
      ///        for more details.
      public: double kp;
      ...
      ///        See for example
      ///        http://www.plugin.org/plugin-latest-userguide.html#sec_3_8_0
      ///        for more details.
      public: double cfm;
      ...
      ///        (http://www.plugin.org/plugin-latest-userguide.html#sec_5_2_0)
      ...
      ///        http://www.plugin.org/plugin-latest-userguide.html#sec_7_3_7
      public: double slip1;
