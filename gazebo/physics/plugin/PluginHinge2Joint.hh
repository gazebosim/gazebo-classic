...
#ifndef _PluginHINGE2JOINT_HH_
#define _PluginHINGE2JOINT_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE PluginHinge2Joint : public Hinge2Joint<PluginJoint>
    {
      /// \brief Constructor
      /// \param[in] _worldID Plugin id of the world.
      /// \param[in] _parent Parent of the Joint
      public: PluginHinge2Joint(BasePtr _parent);

      /// \brief Destructor.
      public: virtual ~PluginHinge2Joint();
