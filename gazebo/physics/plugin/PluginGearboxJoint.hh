...
#ifndef _PluginGEARBOXJOINT_HH_
#define _PluginGEARBOXJOINT_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GAZEBO_VISIBLE PluginGearboxJoint : public GearboxJoint<PluginJoint>
    {
      ...
      public: PluginGearboxJoint(BasePtr _parent);

      /// \brief Destructor.
      public: virtual ~PluginGearboxJoint();
      ...
      /// \param[in] _body an plugin body as the reference link for the gears.
