...
namespace gazebo
{
  namespace physics
  {
    ...
    class ContactManager : public SingletonT<ContactManager>
    {
      /// \brief Constructor.
      private: ContactManager();

      /// \brief Destructor.
      private: virtual ~ContactManager();
      ...
      private: friend class SingletonT<ContactManager>;
    };
    /// \}
  }
}
