 ...
 *
*/
#ifndef _GAZEBO_PHYSICS_INERTIAL_HH_
#define _GAZEBO_PHYSICS_INERTIAL_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE Inertial
    {
      ...
      public: double GetMass() const GAZEBO_DEPRECATED(7.0);
      ...
      public: void SetCoG(const math::Vector3 &_center) GAZEBO_DEPRECATED(7.0);
      ...
      /// \deprecated See version that accepts ignition::math parameters.
      public: void SetCoG(const math::Pose &_c) GAZEBO_DEPRECATED(7.0);
      ...
      public: math::Vector3 GetPrincipalMoments() const GAZEBO_DEPRECATED(7.0);
      ...
      public: math::Vector3 GetProductsofInertia() const GAZEBO_DEPRECATED(7.);
      ...
      public: double GetIXX() const GAZEBO_DEPRECATED(7.0);
      ...
      public: double GetIYY() const GAZEBO_DEPRECATED(7.0);
      ...
      public: double GetIZZ() const GAZEBO_DEPRECATED(7.0);
      ...
      public: double GetIXY() const GAZEBO_DEPRECATED(7.0);
      ...
      public: double GetIXZ() const GAZEBO_DEPRECATED(7.0);
      ...
      public: double GetIYZ() const GAZEBO_DEPRECATED(7.0);
      ...
      /// \deprecated See version that accepts ignition::math parameters.
      public: void Rotate(const math::Quaternion &_rot) GAZEBO_DEPRECATED(7.0);
      ...
      public: math::Matrix3 GetMOI() const GAZEBO_DEPRECATED(7.0);
