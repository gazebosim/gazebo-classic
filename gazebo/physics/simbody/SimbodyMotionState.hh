...
#ifndef _SIMBODYMOTIONSTATE_HH_
#define _SIMBODYMOTIONSTATE_HH_
...
namespace gazebo
{
  namespace physics
  {
    ...
    /// \brief Simbody btMotionState encapsulation
    class SimbodyMotionState : public btMotionState
    {
      /// \brief Constructor
      public: SimbodyMotionState(Link *_link);

      /// \brief Constructor
      // public: SimbodyMotionState(const math::Pose &initPose);

      /// \brief Destructor
      public: virtual ~SimbodyMotionState();
