    ...
    const ignition::math::Vector3 &/*_axis*/)
{
  ...
  // points
  igndbg << "SetAxis Not implemented...\n";
}
...
double SimbodySliderJoint::GetVelocity(unsigned int _index) const
{
  if (_index < this->GetAngleCount())
  {
    ...
    {
      igndbg << "Simbody::GetVelocity() simbody not yet initialized, "
...
//////////////////////////////////////////////////
ignition::math::Angle SimbodySliderJoint::GetHighStop(unsigned int _index)
{
  if (_index >= this->GetAngleCount())
  {
  ...
  {
    ignerr << "Should not be here in code, GetAngleCount > 2?\n";
    return ignition::math::Angle(0.0);  /// \TODO: should return NaN
  }
}

//////////////////////////////////////////////////
ignition::math::Angle SimbodySliderJoint::GetLowStop(unsigned int _index)
{
  if (_index >= this->GetAngleCount())
  {
    ignerr << "Invalid joint index [" << _index
...
//////////////////////////////////////////////////
ignition::math::Vector3 SimbodySliderJoint::GetGlobalAxis(
    unsigned int _index) const
{
  ...
  else
  {
    ...
    {
      igndbg << "Simbody::GetGlobalAxis() sibmody physics"
    ...
    unsigned int _index) const
{
  if (_index < this->GetAngleCount())
  {
    ...
    {
      igndbg << "Simbody::GetAngleImpl() simbody not yet initialized, "
