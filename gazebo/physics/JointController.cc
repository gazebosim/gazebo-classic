...
/////////////////////////////////////////////////
bool JointController::ContainsLink(const Link_V &_vector, const LinkPtr &_value)
{
    ...
    double _target)
{
  ...
  if (this->dataPtr->positions.find(_jointName) !=
      this->dataPtr->positions.end())
  {
    ...
    double _target)
{
  ...
  if (this->dataPtr->velocities.find(_jointName) !=
      this->dataPtr->velocities.end())
  {
