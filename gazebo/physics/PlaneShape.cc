...
//////////////////////////////////////////////////
void PlaneShape::SetAltitude(const ignition::math::Vector3 &/*_pos*/)
{
}

//////////////////////////////////////////////////
void PlaneShape::SetNormal(const ignition::math::Vector3 &_norm)
{
...
//////////////////////////////////////////////////
ignition::math::Vector3 PlaneShape::GetNormal() const
{
  return this->sdf->Get<ignition::math::Vector3>("normal");
}
...
//////////////////////////////////////////////////
void PlaneShape::SetScale(const ignition::math::Vector3 &_scale)
{
