...
EventT<void ()> Events::showLightsSignal;
EventT<void ()> Events::showCamerasSignal;
EventT<void ()> Events::showContactsSignal;
EventT<void ()> Events::wireframeSignal;
EventT<void ()> Events::showPhysicsSignal;
EventT<void ()> Events::showJointsSignal;
EventT<void ()> Events::showBoundingBoxesSignal;
