...
#ifndef GAZEBO_PLUGINS_KEYSTOLINKCMDSPLUGIN_HH_
#define GAZEBO_PLUGINS_KEYSTOLINKCMDSPLUGIN_HH_
...
namespace gazebo
{
  ...
  ///
  class GAZEBO_VISIBLE KeysToPosesPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: KeysToPosesPlugin();
