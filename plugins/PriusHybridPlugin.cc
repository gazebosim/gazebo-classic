...
class gazebo::PriusHybridPluginPrivate
{
  /// \enum DirectionType
  ...
  public: DirectionType directionState = PriusHybridPluginPrivate::FORWARD;
...
{
  gzdbg << "PriusHybridPlugin loading params" << std::endl;

  // shortcut to this->dataPtr
  PriusHybridPluginPrivate *dPtr = this->dataPtr.get();

  dPtr->node.Subscribe("/joy", &PriusHybridPlugin::OnPriusCommand, this);
...
/////////////////////////////////////////////////
void PriusHybridPlugin::OnPriusCommand(const ignition::msgs::Joy &_joyMsg)
{
