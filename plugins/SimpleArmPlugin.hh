...
#ifndef _GAZEBO_SIMPLEARM_PLUGIN_HH_
#define _GAZEBO_SIMPLEARM_PLUGIN_HH_
...
namespace gazebo
{
  class SimpleArmPlugin : public ModelPlugin
  {
    /// \brief Constructor
    public: SimpleArmPlugin();

    /// \brief Destructor
    public: virtual ~SimpleArmPlugin();
