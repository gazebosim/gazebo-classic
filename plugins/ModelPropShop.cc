...
void ModelPropShop::Update()
{
  ...
  if (this->scene && this->scene->GetInitialized())
  {
    ...
    printf("Update\n");
    rendering::VisualPtr vis = this->scene->GetVisual("box");
    if (vis)
    {
