...
#ifndef GAZEBO_PLUGINS_DISTRIBUTEDSIMULATIONMANAGER_HH_
#define GAZEBO_PLUGINS_DISTRIBUTEDSIMULATIONMANAGER_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE DistributedSimulationManager: public SystemPlugin
  {
    /// \brief Destructor
    public: virtual ~DistributedSimulationManager();
