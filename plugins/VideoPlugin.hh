 ...
 *
*/
#ifndef GAZEBO_VIDEOPLUGIN_HH_
#define GAZEBO_VIDEOPLUGIN_HH_
...
namespace gazebo
{
  ...
  ///    <plugin name="random" filename="libVideoPlugin.so">
  ///
  ...
  class GAZEBO_VISIBLE VideoPlugin : public VisualPlugin
  {
    /// \brief Constructor.
    public: VideoPlugin();
