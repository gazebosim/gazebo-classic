...
SimpleArmPlugin::SimpleArmPlugin()
{
  ...
  this->yaw = 0;
  gzerr << "SimpleArm Plugin Constructor!" << std::endl;
}
...
/////////////////////////////////////////////////
void SimpleArmPlugin::OnHydra(ConstHydraPtr &_msg)
{
...
*/
  ...
  std::cerr << "SimpleArm Plugin Restart!" << std::endl;
  //this->world->Reset();
}

/////////////////////////////////////////////////
void SimpleArmPlugin::SetRightFingers(double _angle)
{
...
/////////////////////////////////////////////////
void SimpleArmPlugin::SetLeftFingers(double _angle)
{
...
/////////////////////////////////////////////////
void SimpleArmPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  // Get the world name.
  this->model = _parent;
 ...
 // this->rightBumper = false;
  ...
  gzerr << "SimpleArm Plugin Loaded!" << std::endl;

  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&SimpleArmPlugin::Update, this, _1));
}

/////////////////////////////////////////////////
void SimpleArmPlugin::Update(const common::UpdateInfo & /*_info*/)
{
  boost::mutex::scoped_lock lock(this->msgMutex);
