...
//////////////////////////////////////////////////
std::shared_ptr<FlashLightSetting>
  LEDPluginPrivate::SettingByLightNameAndLinkName(
  const std::string &_lightName, const std::string &_linkName) const
{
...
//////////////////////////////////////////////////
LEDPlugin::LEDPlugin() : ModelPlugin(),
  dataPtr(new LEDPluginPrivate)
{
  // Create a node
...
void LEDPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(
    std::bind(&LEDPlugin::OnUpdate, this));
}

//////////////////////////////////////////////////
void LEDPlugin::OnUpdate()
{
  common::Time currentTime = this->dataPtr->world->SimTime();
...
//////////////////////////////////////////////////
bool LEDPlugin::TurnOn(const std::string &_lightName)
{
  return this->TurnOn(_lightName, "");
}

//////////////////////////////////////////////////
bool LEDPlugin::TurnOn(
...
//////////////////////////////////////////////////
bool LEDPlugin::TurnOff(const std::string &_lightName)
{
