...
class ServerFixture : public testing::Test
{
  ...
  protected: ignition::math::Pose GetEntityPose(const std::string &_name);
  ...
  protected: void SpawnUnitContactSensor(const std::string &_name,
                 ...
                 const ignition::math::Vector3 &_pos,
                 const ignition::math::Vector3 &_rpy, bool _static = false);
  ...
  protected: std::map<std::string, ignition::math::Pose> poses;
  ...
  protected: ignition::common::Time simTime, realTime, pauseTime;
