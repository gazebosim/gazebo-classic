...
TEST_F(PR2Test, Param)
{
  ...
  sdf::ParamT<ignition::common::Color> colorP("c",
      ignition::common::Color(.1, .2, .3, 1), 0);
  sdf::ParamT<ignition::math::Vector3> vec3P("v3",
      ignition::math::Vector3(1, 2, 3), 0);
  sdf::ParamT<ignition::math::Pose> poseP("v3",
      ignition::math::Pose(ignition::math::Vector3(1, 2, 3),
        ignition::math::Quaternion(0, 0, M_PI)), 0);
