...
void ContactSensor::StackTest(const std::string &_physicsEngine)
{
  ...
  ASSERT_TRUE(contactSensor01.get());
  ...
  ASSERT_TRUE(contactSensor02.get());
  ...
  ASSERT_TRUE(contactModel01.get());
  ASSERT_TRUE(contactModel02.get());
