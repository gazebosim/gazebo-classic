...
#ifndef GAZEBO_TEST_INTEGRATION_CAMERAGUI_HH
#define GAZEBO_TEST_INTEGRATION_CAMERAGUI_HH

#include "gazebo/gui/QTestFixture.hh"

/// \brief A test class for the user camera.
class CameraGUITest : public QTestFixture
{
  Q_OBJECT
