...
TEST_F(SpeedThreadPR2Test, PR2SplitImpulseWorldFalseTrue)
{
...
/////////////////////////////////////////////////
// Test ODE threaded position correction.
TEST_F(SpeedThreadPR2Test, PR2SplitImpulseWorldTrueFalse)
{
  Load("worlds/pr2_no_sensors_test.world", true);
...
/////////////////////////////////////////////////
// Test ODE threaded position correction.
TEST_F(SpeedThreadPR2Test, PR2SplitImpulseWorldTrueTrue)
{
  Load("worlds/pr2_no_sensors_test.world", true);
  ...
  // Collect threaded statistics
  common::Time thread2AvgTime, thread2MaxTime, thread2MinTime;
  stats(world, thread2AvgTime, thread2MaxTime, thread2MinTime);

  std::cout << "Thread2 Time\n";
  std::cout << "\t Avg[" << thread2AvgTime << "]\n"
            << "\t Max[" << thread2MaxTime << "]\n"
            << "\t Min[" << thread2MinTime << "]\n";
}
...
/////////////////////////////////////////////////
// Test ODE threaded position correction.
TEST_F(SpeedThreadPR2Test, PR2SplitImpulseWorldFalseFalse)
{
  Load("worlds/pr2_no_sensors_test.world", true);
  ...
  // Collect threaded statistics
  common::Time base2AvgTime, base2MaxTime, base2MinTime;
  stats(world, base2AvgTime, base2MaxTime, base2MinTime);

  std::cout << "Base2 Time\n";
  std::cout << "\t Avg[" << base2AvgTime << "]\n"
            << "\t Max[" << base2MaxTime << "]\n"
            << "\t Min[" << base2MinTime << "]\n";
}
