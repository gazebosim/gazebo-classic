...
void ConcaveMeshTest::SubmeshCollisionTest(const std::string &_physicsEngine)
{
  ...
  EXPECT_DOUBLE_EQ(raySensor->Range(0), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(1), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(2), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(3), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(4), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(5), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(6), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(7), GZ_DBL_INF);
  ...
  EXPECT_DOUBLE_EQ(raySensor->Range(12), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(13), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(14), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(15), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(16), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(17), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(18), GZ_DBL_INF);
  EXPECT_DOUBLE_EQ(raySensor->Range(19), GZ_DBL_INF);
}
