...
TEST_F(Issue1082Test, PIDLimitsVelocity)
{
  ...
  gazebo::physics::ModelPtr model = world->GetModel("pioneer2dx");
  ...
  math::Pose startPose = model->GetWorldPose();

  msgs::JointCmd msg;
  msg.set_name("pioneer2dx::left_wheel_hinge");
  ...
  math::Pose endPose = model->GetWorldPose();
