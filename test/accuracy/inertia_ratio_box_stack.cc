...
// gravity applied
// force on top box
// constraint error tolerance (iteration cutoff)
                      ...
                      public testing::WithParamInterface<char1int1double4>
{
  ...
  /// \param[in] _tolerance constraint solver error tolerance
...
INSTANTIATE_TEST_CASE_P(EnginesDtLinearBoxStack, RigidBodyTest,
  ...
  , ::testing::Range(DT_MIN, DT_MAX, DT_STEP) /* time step size */
  , ::testing::Values(1.0) /* box 5 mass */
